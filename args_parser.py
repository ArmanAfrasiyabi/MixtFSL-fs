...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 16 02:10:13 2020
...
def args_parser(fs_approach):
    ...
    args.add_argument('--backbone', default='ResNet12', help='Conv4|ResNet12|ResNet18|WideResNet')   
    ...
    #args.add_argument('--benchmarks_dir', default = '/home/ari/Documents/few_shot_lablatory/fs_benchmarks/', help = 'on the computer the directory which the benchmarks are strored')
    args.add_argument('--benchmarks_dir', default = '/home/arafr1/scratch/fs_benchmarks/', help = 'on the server: the directory which the benchmarks are strored')
    args.add_argument('--checkpoint_dir', default = '/home/arafr1/scratch/checkpoints/pmm_results/model/', help = 'the directory for saving the best_model')
    #args.add_argument('--embd_dir', default = '/home/ari/scratch/results/temp_base_embeddings/', help = 'the directory for saving the embeddings')
    ...
    args.add_argument('--n_query', default=40,type=int,  help='pretented unlabled data for loss calculation in meta-learning')
    ...
    if fs_approach == 'meta-learning':
        ...
        args.add_argument('--batch_size', default = 128, type=int,  help='200 the batch size during base-training')  
