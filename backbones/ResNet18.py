...
def resnet18(flatten=True):
    dropblock_size = 5              #% https://github.com/bl0/negative-margin.few-shot/blob/master/lib/config.py
    drop_rate = 0.0
    return ResNet18(SimpleBlock, [64, 128, 256, 512], flatten, drop_rate, dropblock_size)